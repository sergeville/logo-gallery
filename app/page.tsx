  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900" data-testid="home-container">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" data-testid="main-content">
        ...
        <div className="text-center" data-testid="welcome-section">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
            Latest Uploads
          </h2>
          {session?.user ? (
            <p className="text-gray-600 dark:text-gray-300" data-testid="user-welcome">
              Welcome back, {session.user.name}!
            </p>
          ) : (
            <p className="text-gray-600 dark:text-gray-300" data-testid="guest-welcome">
